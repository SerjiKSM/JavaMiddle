// Napisat kod dlya mnogopotochnogo pogshchota symmu elementa massiva czelux chisel
// sravnit skorost podschota s prostum algoritmom
...
public class ArraySum extends Thread {
	...
	int finish;
	int sumBlock = 0;
	final static int length = 10; //10_000_000;
	final static int block = 10;  //10_000_000;
